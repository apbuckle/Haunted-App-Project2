...
const TheSimpsons = new Cast({name: 'Homer, Marge, Lisa, Bart, Maggie', favoriteHorrorMovie: 'Treehouse of Horrors', years: 38, costume: 'glowing mutanted outfits'})
const PickleRick = new Cast({name: 'Rick', favoriteHorrorMovie: 'Event Horizon', years: 4, costume: 'Pickle Rickd'})
const BelcherFamily = new Cast({name: 'Belchers', favoriteHorrorMovie: 'none', years: 8, costumes: 'Season 3 Halloween episode costumes'})
const Creeper = new Cast({name: 'Creeper', favoriteHorrorMovie: 'Jeepers Creepers', years: 17, costume: 'Winged Scare Crow'})
...
const Chucky = new Cast({name: 'Chucky', favoriteHorrorMovie: 'Childs play', years: 30, costume: 'My Buddy Doll outfit with butcher a knife'})
...
const NuclearMutants = new Attractions({name: 'Nuclear Mutants', description: 'Mr. Burns finally blow up Springfield, but something has survived!', cast:[TheSimpsons]})
...
const Portals = new Attractions({name: 'Portals', description: 'Are you prepared for where Rick will open his portal to?', cast:[PickleRick]})
...
const SweetDreams = new Attractions({name: 'Sweet Terror Nights', description: 'The Creep and Candy Man have come together to rain terror on this special night.', cast:[Creeper, CandyMan]})
