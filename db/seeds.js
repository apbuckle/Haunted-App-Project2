...
const { Venue, Attraction, Cast } = Schema
...
const NeatherWorld = new Venue({ name: 'Neather World', city: 'Atlanta', age_range: '18+', attractions:[ZombieHouse, TerrorRoad]})

Venue.deleteMany()
    .then (() => {
        return Venue.insertMany([NeatherWorld])
    })
    .then(() => {
